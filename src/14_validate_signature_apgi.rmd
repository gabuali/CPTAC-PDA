...
```{r load_data}
# Paths
apgi_prot_path <- here("Data", "APGI-PDA", "APGI_protein_matrix_gene_symbols.csv")
apgi_clin_path <- here("Data", "APGI-PDA", "APGI_clinical_metadata.csv")
sig_path <- here("Results", "MOFA_Factor2_Protein_LassoSignature_18Proteins.csv")
