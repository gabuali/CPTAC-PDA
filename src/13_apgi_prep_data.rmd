...
gene_names <- read.csv(here("Data", "APGI-PDA", "E0021_P01_SRL_with_triplicates-srl.tsv"), sep = "\t")
...
write.csv(gene_names, here("Data", "APGI-PDA", "APGI_protein_and_gene_names.csv"), row.names = FALSE)
```
