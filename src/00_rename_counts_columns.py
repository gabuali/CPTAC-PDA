...
def rename_counts_columns():
    ...
    mappings from gdc_sample_sheet.2026-06-10.tsv.
    """
    # Define paths based on your directory structure
    base_path = Path("/Users/galebabu-ali/Documents/Projects/CPTAC")
    sample_sheet_path = base_path / "gdc_sample_sheet.2026-06-10.tsv"
    counts_file_path = base_path / "PDAC_transcriptomics_RAW_counts.tsv"
    output_file_path = base_path / "PDAC_transcriptomics_RAW_counts_renamed.tsv"
